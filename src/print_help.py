...
def print_help(version: str, last_update_date: str) -> None:
    ...
    print('-O or --output-format:')
    print('    Output format: `genbank` or `bed`.')
    print('    Default: `genbank`.')
    print('-r or --target-seq-ids:')
    print('    Comma-separated list of target sequence IDs to process.')
    print('    Examples: "seq_1" or "seq_1,seq_9,seq_12".')
    print('    Dasta sequence id is the part of its header before the first space.')
    print('    Default: process all target sequences.')
    print('-c or --lower-coverage-thresholds:')
    print('    Comma-separated list of lower coverage threshold(s).')
    print('    To annotate regions with coverage < c.')
    print('    Default: 10.')
    print('    To disable it, specify `-c off`.')
    print('-n or --no-zero-output:')
    print('    Disable annotation of zero-coverage regions.')
    print('    Disabled by default.')
    print('-C or --upper-coverage-thresholds:')
    print('    Comma-separated list of coverage threshold(s).')
    print('    To annotate regions with coverage > C.')
    print('    Default: 500.')
    print('    To disable it, specify `-C off`.')
    print('-X or --upper-coverage-coefficients:')
    print('    Comma-separated list of coverage coefficient(s).')
    print('    To annotate regions with coverage > 1.7×M,')
    print('      where M is median coverage, specify `-X 1.7`.')
    print('    Default: 2.0.')
    print('    To disable it, specify `-X off`.')
