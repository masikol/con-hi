...
class TestCountCovForAllRefs:
    ...
    def test_coverage_counting(
        ...
        # end def conforms_cov_line_pattern
    ...
    # end def test_coverage_counting
# end class TestCountCovForAllRefs
...
class TestGetCoverageForReference:
    ...
    # end def test_get_covs_seq_2
# end class TestGetCoverageForReference
